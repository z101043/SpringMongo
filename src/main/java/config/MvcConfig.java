...
import com.hyunkyoic.yisunsin.util.CommonSession;
 ...
 */
@Configuration
@ComponentScan(basePackages="com.hyunkyoic.yisunsin")
@EnableWebMvc
...
public class MvcConfig extends WebMvcConfigurerAdapter // 인터셉터를 추가하기 위해 WebMvcConfigurerAdapter 를 상속한다
{
    ...
    public static PropertyPlaceholderConfigurer properties() {
      ...
      Resource[] resources =
          new ClassPathResource[] {new ClassPathResource("configuration/properties/config.properties")};
